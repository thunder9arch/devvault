...
export class Backend implements backendInterface {
    ...
    async addSnippet(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addSnippet(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteSnippet(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getSnippets(): Promise<Array<Snippet>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSnippets();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
